...
def uitvragen(client,ServerIP):
    ...
    if not os.path.isfile("C:\\Users\\Ward Bakker\\PycharmProjects\\Python1\\"+r17+".csv"):
        ...
        wr.writerow(["Count", "Time", "Datum", "Hostname", "Platform", "Encoding", "Resultaat", "Processen", "Services",
                     "CPU Usage", "RAM %", "RAM Geheugen Vrij", "RAM gebeugen Usage", "RAM totaal", "IP", "HDD ruimte",
                     "System Uptime"])
        wr.writerow(Time)
    else:
